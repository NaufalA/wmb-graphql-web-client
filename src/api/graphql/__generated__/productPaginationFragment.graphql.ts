...
export type productPaginationFragment$data = {
  ...
  readonly " $fragmentType": "productPaginationFragment";
};
export type productPaginationFragment$key = {
  readonly " $data"?: productPaginationFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"productPaginationFragment">;
};

import productPaginationQuery_graphql from './productPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": productPaginationQuery_graphql
    }
  },
