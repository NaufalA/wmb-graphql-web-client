...
export type userPaginationFragment$data = {
  readonly listUsers: {
  ...
  readonly " $fragmentType": "userPaginationFragment";
};
export type userPaginationFragment$key = {
  readonly " $data"?: userPaginationFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"userPaginationFragment">;
};

import userPaginationQuery_graphql from './userPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": userPaginationQuery_graphql
    }
  },
